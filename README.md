...
```javascript
number2json = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-to-json@v0.0.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-to-json@v0.0.1-umd/browser.js"></script>
```
